    ...
    <div class="row top-more-5 menuItems">
        <div class="col-4" id="itemsPC">
            ...
            <div class="row">
                <div class="col-5"></div>
                <div class="col-7">
                    <button type="button" class="btn btn-sm btn-success" id="btnEncontrarEnderecos">Procurar Endereços
                    </button>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="md-form">
                            ...
                            <label for="capacidadeCriarViagem"> <i class="fas fa-users"></i> Capacidade de passageiros
                                para
                                a viagem</label>
                        </div>
                    </div>
        ...
        <div class="col-1"></div>
        <div class="col" id="mapDiv">
            <div id="map">

            </div>
        </div>
    </div>
    <div class="toHide row top-more-10 menuItems" id="myMapDiv">
        <div class="col-10">
            <div class="row" id="controlCamposInicial">
                <div class="col-10">
                    <i class="fas fa-map-marked-alt"></i> Ponto inicial
